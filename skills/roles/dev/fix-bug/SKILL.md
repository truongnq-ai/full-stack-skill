---
name: dev-fix-bug
description: Skill for dev to fix-bug.
metadata:
  priority: P1
  version: 1.0
---
...
> **Use this skill when**: The workflow needs to execute fix-bug tasks.
> **Triggers**: `fix-bug`, `dev`

## 1. Goal
Execute fix-bug following best practices from industry standards (like crewAI/MetaGPT).
