...
description: Standards for creating clear, effective, and formalized software architecture diagrams (C4, UML).
metadata:
  labels: [architecture, diagram, c4-model, documentation, best-practices]
  triggers:
