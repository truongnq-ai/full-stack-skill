---
description: "Plan testing, design Test Cases (Boundary, Decision Table...), prepare data and environments."
---
# QA: Test Planning

> **Trigger**: Use when a new feature is ready for testing phase and requires formal test preparation.
> **Tools**: Jira MCP, Zephyr MCP, database query tools for seeding data.
...
- **Skills**: skills/roles/tester/test-data-management/SKILL.md, skills/roles/tester/environment-management/SKILL.md

## Step 4 - Test Plan Checkpoint
- **Checkpoint**: Show the summary of generated test cases and environment readiness to the Test Manager or Dev for approval.
